...
SECRET_KEY = 'django-insecure-=$@=9ayv#mrp+$^$zs70m^^3xbhjn$$ah@gq4**c)70kpa1iib'
...
INSTALLED_APPS = [
    'daphne',  # Debe estar al inicio para WebSockets
...
# En desarrollo usamos InMemoryChannelLayer
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for real-time Kanban board management',
    'VERSION': '1.0.0',
